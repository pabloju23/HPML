...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out_shape = out.shape  # Store the shape of out
        ...
        dout, grads['W3'], grads['b3'] = fc_backward(dscores, cache3)
        dout, grads['W2'], grads['b2'] = fc_relu_backward(dout, cache2)

        # Reshape dout to the original shape of out
